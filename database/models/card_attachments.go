...
var CardAttachmentWhere = struct {
	...
	ID:       whereHelperstring{field: "`card_attachments`.`id`"},
	Filename: whereHelperstring{field: "`card_attachments`.`filename`"},
	Time:     whereHelpertime_Time{field: "`card_attachments`.`time`"},
	CardID:   whereHelperstring{field: "`card_attachments`.`card_id`"},
	UserID:   whereHelperstring{field: "`card_attachments`.`user_id`"},
}
...
var (
	...
	cardAttachmentColumnsWithoutDefault = []string{"id", "filename", "time", "card_id", "user_id"}
	cardAttachmentColumnsWithDefault    = []string{}
...
func FindCardAttachment(exec boil.Executor, iD string, selectCols ...string) (*CardAttachment, error) {
...
func CardAttachmentExists(exec boil.Executor, iD string) (bool, error) {
	var exists bool
