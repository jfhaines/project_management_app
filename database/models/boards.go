...
type Board struct {
	...
	Background null.String `boil:"background" json:"background,omitempty" toml:"background" yaml:"background,omitempty"`
...
var BoardWhere = struct {
	...
	Background whereHelpernull_String
}{
	ID:         whereHelperstring{field: "`boards`.`id`"},
	Name:       whereHelperstring{field: "`boards`.`name`"},
	Background: whereHelpernull_String{field: "`boards`.`background`"},
}
...
type boardR struct {
	Columns ColumnSlice `boil:"Columns" json:"Columns" toml:"Columns" yaml:"Columns"`
}
...
func (r *boardR) GetColumns() ColumnSlice {
	if r == nil {
		return nil
	}
	return r.Columns
...
var (
	boardAllColumns            = []string{"id", "name", "background"}
	boardColumnsWithoutDefault = []string{"id", "name", "background"}
	boardColumnsWithDefault    = []string{}
...
func (q boardQuery) One(exec boil.Executor) (*Board, error) {
	o := &Board{}
...
func (q boardQuery) All(exec boil.Executor) (BoardSlice, error) {
	var o []*Board
...
func (q boardQuery) Count(exec boil.Executor) (int64, error) {
	var count int64
...
func (q boardQuery) Exists(exec boil.Executor) (bool, error) {
	var count int64
...
// Columns retrieves all the column's Columns with an executor.
func (o *Board) Columns(mods ...qm.QueryMod) columnQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`columns`.`board_id`=?", o.ID),
	)

	return Columns(queryMods...)
}

// LoadColumns allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (boardL) LoadColumns(e boil.Executor, singular bool, maybeBoard interface{}, mods queries.Applicator) error {
	var slice []*Board
	var object *Board
	...
	query := NewQuery(
		qm.From(`columns`),
		qm.WhereIn(`columns.board_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load columns")
	}

	var resultSlice []*Column
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice columns")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on columns")
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.BoardID {
				local.R.Columns = append(local.R.Columns, foreign)
				if foreign.R == nil {
					foreign.R = &columnR{}
				}
...
// AddColumns adds the given related objects to the existing relationships
// of the board, optionally inserting them as new records.
// Appends related to o.R.Columns.
// Sets related.R.Board appropriately.
func (o *Board) AddColumns(exec boil.Executor, insert bool, related ...*Column) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.Columns = append(o.R.Columns, related...)
	}
...
func FindBoard(exec boil.Executor, iD string, selectCols ...string) (*Board, error) {
	boardObj := &Board{}
	...
	if err = boardObj.doAfterSelectHooks(exec); err != nil {
		return boardObj, err
	}
...
func (o *Board) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for boards")
	}
...
func (o *Board) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	var err error
...
func (q boardQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
...
func (o BoardSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	ln := int64(len(o))
	if ln == 0 {
		return 0, nil
	}
...
func (o *Board) Upsert(exec boil.Executor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for boards")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for boards")
	}
...
func (o *Board) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
...
func (q boardQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
...
func (o BoardSlice) DeleteAll(exec boil.Executor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
...
func BoardExists(exec boil.Executor, iD string) (bool, error) {
	var exists bool
...
func (o *Board) Exists(exec boil.Executor) (bool, error) {
	return BoardExists(exec, o.ID)
}
