...
type Card struct {
	...
	ColumnID    int         `boil:"column_id" json:"column_id" toml:"column_id" yaml:"column_id"`
...
var CardWhere = struct {
	...
	ColumnID:    whereHelperint{field: "`cards`.`column_id`"},
}
...
var (
	...
	cardColumnsWithoutDefault = []string{"title", "description", "date_due", "column_id"}
...
func FindCard(exec boil.Executor, iD int, selectCols ...string) (*Card, error) {
	cardObj := &Card{}
...
func CardExists(exec boil.Executor, iD int) (bool, error) {
	var exists bool
