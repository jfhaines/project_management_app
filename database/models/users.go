...
func (r *userR) GetCardAttachments() CardAttachmentSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetCardComments() CardCommentSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetCardUsers() CardUserSlice {
	if r == nil {
		return nil
	}
	return r.CardUsers
...
var (
	userAllColumns            = []string{"id", "username", "email", "password"}
	userColumnsWithoutDefault = []string{"id", "username", "email", "password"}
...
func (o *User) CardAttachments(mods ...qm.QueryMod) cardAttachmentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`card_attachments`.`user_id`=?", o.ID),
	)
...
func (o *User) CardComments(mods ...qm.QueryMod) cardCommentQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`card_comments`.`user_id`=?", o.ID),
	)
...
func (o *User) CardUsers(mods ...qm.QueryMod) cardUserQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`card_users`.`user_id`=?", o.ID),
	)
...
func (userL) LoadCardAttachments(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`card_attachments.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadCardComments(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`card_comments.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadCardUsers(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`card_users`),
		qm.WhereIn(`card_users.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddCardAttachments(exec boil.Executor, insert bool, related ...*CardAttachment) error {
	var err error
...
// Sets related.R.User appropriately.
func (o *User) AddCardComments(exec boil.Executor, insert bool, related ...*CardComment) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
// Sets related.R.User appropriately.
func (o *User) AddCardUsers(exec boil.Executor, insert bool, related ...*CardUser) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
