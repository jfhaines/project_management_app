...
var (
	...
	cardLabelColumnsWithoutDefault = []string{"text", "colour", "card_id"}
	cardLabelColumnsWithDefault    = []string{"id"}
...
func FindCardLabel(exec boil.Executor, iD int, selectCols ...string) (*CardLabel, error) {
...
func (o *CardLabel) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	o.ID = int(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == cardLabelMapping["id"] {
		goto CacheNoHooks
	}
...
func CardLabelExists(exec boil.Executor, iD int) (bool, error) {
	var exists bool
